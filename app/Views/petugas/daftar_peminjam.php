<div class="body flex-grow-1 px-3">
    <div class="container-lg">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="myTable" class="table table-bordered table-striped table-hover display responsive"
                        width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><img src="<?= base_url() ?>buku/<?= $peminjam['sampul_buku'] ?>" alt="" width="50">
                                </td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning mr-2" id="btn-detail-member"
                                        ...
                                        data-id_peminjaman="<?= $peminjam['id_peminjam'] ?>"
                                        data-nama_lengkap="<?= $peminjam['nama_lengkap'] ?>"
                                        data-email="<?= $peminjam['email'] ?>"
                                        data-no_telpon="<?= $peminjam['no_telpon'] ?>"
                                        data-alamat="<?= $peminjam['alamat'] ?>"> <i
                                            class="fa-solid fa-address-card mr-2"></i> Member
                                    </button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-success mr-2" id="btn-edit-peminjam"
                                        ...
                                        data-total_pinjam="<?= $peminjam['total_pinjam'] ?>"> Edit
                                    </button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url() ?>proses_edit_peminjaman">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="di-kembalikan" class="form-control" name="status_peminjaman"
                            placeholder="status_peminjaman Buku" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="total_pinjam" class="form-label">Total Pinjam</label>
                        <input type="number" class="form-control" name="total_pinjam" id="total_pinjam"
                            placeholder="total_pinjam Buku" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="total_pengembalian"
                            placeholder="Masukkan Total Pengembalian Buku" oninput="validateTotalPengembalian()"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="total_pinjam" class="form-label">Tanggal Hari Ini</label>
                        <input type="date" value="" class="form-control" id="tanggal_hari_ini" name="tanggal_hari_ini"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="total_pinjam" class="form-label">Total Keterlambatan</label>
                        <input type="text" class="form-control" id="total_keterlambatan" name="total_keterlambatan"
                            readonly>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap"
                        aria-describedby="penerbit buku" readonly>
                </div>
                <div class="mb-3">
                    <label for="nama" class="form-label">Email</label>
                    <input type="text" class="form-control" name="email" id="email" aria-describedby="penerbit buku"
                        readonly>
                </div>
                <div class="mb-3">
...
function hitungTotalKeterlambatan() {
    ...
    if (tanggalPengembalian && tanggalHariIni > tanggalPengembalian) {
        // Hitung selisih hari
        var selisihHari = Math.floor((new Date(tanggalHariIni) - new Date(tanggalPengembalian)) / (24 * 60 * 60 *
            1000));
