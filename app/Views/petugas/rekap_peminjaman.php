               ...
               <div class="card">
                   <div class="card-body">
                       <form action="<?= base_url()?>/cetak_peminjaman" target="_blank" method="post">
                           ...
                           <button type="submit" class="btn btn-danger w-100 mt-3"><i class='fas fa-print'></i>
                               PRINT</button>
                       </form>
                   </div>
               </div>
               ...
               <div class="modal-body">
                   <form method="post" action="<?= base_url() ?>proses_edit_peminjaman">
                       <input type="hidden" class="form-control" name="id_peminjam" id="id_peminjam"
                           aria-describedby="id peminjaman buku">
                       <div class="mb-3">
...
$(document).on('click', '#btn-edit-peminjam', function() {
    $('.modal-body #id_peminjam').val($(this).data('id_peminjam'));
