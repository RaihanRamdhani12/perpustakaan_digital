                ...
                <div class="card-body">
                    <table id="myTable" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><img src="<?= base_url() ?>buku/<?= $pengembali['sampul_buku'] ?>" alt=""
                                        width="50"></td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning mr-2" id="btn-detail-denda"
                                        ...
                                        data-uang_kembalian="<?= $pengembali['uang_kembalian'] ?>"> <i
                                            class="fas fa-money-bill-wave"></i> Denda
                                    </button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-success mr-2" id="btn-detail-member"
                                        ...
                                        data-alamat="<?= $pengembali['alamat'] ?>"> <i
