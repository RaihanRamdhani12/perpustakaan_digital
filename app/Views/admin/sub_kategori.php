                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success mr-2" id="btn-edit-sub-k"
                                        ...
                                        data-nama_kategori_buku="<?= $sub_k['nama_kategori_buku'] ?>"> Edit
                                    </button>
                                    <button type="button" class="btn btn-danger"
                                        onclick="hapusBuku('<?= $sub_k['id_sub_kategori'] ?>', '<?= $sub_k['nama_sub_kategori'] ?>')">
                                        Hapus</i>
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url() ?>proses_tambah_sub_kategori">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id_sub_kategori" value="<?= $kode_sub ?>"
                            readonly>
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Nama Sub Kategori</label>
                        <input type="text" class="form-control" name="nama_sub_kategori"
                            aria-describedby="nama sub kategori buku" placeholder="Nama Sub Kategori">
                    </div>
                    <div class="mb-3">
                        ...
                        <select id="id_kategori_buku" name="id_kategori_buku" class="form-select"
                            ...
                            <option value="<?= $k_buku['id_kategori_buku']?>"><?= $k_buku['nama_kategori_buku']?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url() ?>proses_edit_sub_kategori">
                    <div class="mb-3">
                        <label for="input" class="form-label">Id Sub Kategori</label>
                        <input type="text" class="form-control" name="id_sub_kategori" id="id_sub_kategori"
                            aria-describedby="id_sub_kategori" placeholder="id_sub_kategori" readonly>
                    </div>
                    <div class="mb-3">
...
<!-- script hapus buku -->
<script>
function hapusBuku(id_sub_kategori, nama_sub_kategori) {
    Swal.fire({
