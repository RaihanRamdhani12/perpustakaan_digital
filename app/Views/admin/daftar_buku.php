                ...
                <div class="card-body">
                    <table id="myTable" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $buku['id_buku'] ?></td>
                                <td><img src="<?= base_url() ?>buku/<?= $buku['sampul_buku'] ?>" alt="" width="50">
                                </td>
                                <td><?= $buku['judul'] ?></td>
                                <?php 
                                ...
                                <td><?= $buku['stok'] ?></td>
                                <td>
                                    <button type="button" class="btn btn-primary mr-2" id="btn-edit-buku"
                                        ...
                                        data-penulis="<?= $buku['penulis'] ?>" data-stok="<?= $buku['stok'] ?>"
                                        data-sinopsis="<?= $buku['sinopsis'] ?>"
                                        data-penerbit="<?= $buku['penerbit'] ?>"
                                        data-tahun_terbit="<?= $buku['tahun_terbit'] ?>">Edit</i>
                                    </button>

                                    <button type="button" class="btn btn-danger"
                                        onclick="hapusBuku('<?= $buku['id_buku'] ?>', '<?= $buku['judul'] ?>')">
                                        Hapus
                                    </button>
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url() ?>proses_tambah_buku" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id_buku" value="<?= $kode_buku ?>"
                            placeholder="Judul Buku" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" aria-describedby="judul buku"
                            placeholder="Judul Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Penulis</label>
                        <input type="text" class="form-control" name="penulis" aria-describedby="penulis buku"
                            placeholder="Penulis Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Penerbit</label>
                        <input type="text" class="form-control" name="penerbit" aria-describedby="penerbit buku"
                            placeholder="Penerbit Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Tahun Terbit</label>
                        <input type="number" class="form-control" name="tahun_terbit"
                            aria-describedby="Tahun Terbit buku" placeholder="Tahun Terbit Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Sinopsis</label>
                        <input type="text" class="form-control" name="sinopsis" aria-describedby="Sinopsis"
                            placeholder="Sinopsis">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Stok</label>
                        <input type="number" class="form-control" name="stok" aria-describedby="Stok"
                            placeholder="Stok Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Kategori Buku</label>
                        <select id="id_kategori_buku" name="id_kategori_buku" class="form-select"
                            placeholder="id_kategori_buku">
                            <option value="null">--Pilih Kategori--</option>
                            <?php foreach($semua_kategori_buku as $k_buku ): ?>
                            <option value="<?= $k_buku['id_kategori_buku']?>">
                                <?= $k_buku['nama_kategori_buku']?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="sampul_buku" aria-describedby="sampul buku"
                            placeholder="Sampul Buku" required>
                    </div>
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url() ?>proses_edit_buku" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="id_buku" id="id_buku"
                        aria-describedby="id judul buku" placeholder="Judul Buku">
                    <div class="mb-3">
                        <label for="input" class="form-label">Id Buku</label>
                        <input type="text" class="form-control" id="id_buku" name="id_buku"
                            aria-describedby="judul buku" placeholder="Judul Buku" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" id="judul" aria-describedby="judul buku"
                            placeholder="Judul Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Penulis</label>
                        <input type="text" class="form-control" name="penulis" id="penulis"
                            aria-describedby="penulis buku" placeholder="Penulis Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Penerbit</label>
                        <input type="text" class="form-control" name="penerbit" id="penerbit"
                            aria-describedby="penerbit buku" placeholder="Penerbit Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Tahun Terbit</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="sinopsis" id="sinopsis"
                            aria-describedby="sinopsis" placeholder="Sinopsis">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Stok</label>
                        <input type="number" class="form-control" name="stok" id="stok"
                            aria-describedby="Tahun Terbit buku" placeholder="Stok Buku">
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Sampul</label>
                        <input type="file" class="form-control" name="sampul_buku" id="sampul_buku"
                            aria-describedby="sampul buku" placeholder="Sampul Buku">
                        <?= csrf_field() ?>
                    </div>
...
<div class="modal fade" id="editSubKatBuku" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url() ?>proses_edit_kategori" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="input" class="form-label">Id Buku</label>
                        <input type="text" class="form-control" id="id_buku" name="id_buku" id="id_sub_kategori"
                            aria-describedby="judul buku" placeholder="Judul Buku" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Judul</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="" id="nama_kategori_buku" name="id_kategori_buku"
                            id="id_sub_kategori" aria-describedby="judul buku" placeholder="Belum Ada Kategori"
                            readonly>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_sub_kategori" id="nama_sub_kategori"
                            aria-describedby="judul buku" placeholder="Belum Ada Sub Kategori" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="input" class="form-label">Nama Kategori Baru</label>
                        <select id="id_kategori_buku_edit" name="id_kategori_buku" class="form-select"
                            placeholder="id_kategori_buku">
                            <option value="null">--Pilih Kategori--</option>
                            <?php foreach($semua_kategori_buku as $k_buku ): ?>
                            <option value="<?= $k_buku['id_kategori_buku']?>">
                    ...
                    <div class="mb-3 " id="loadSubKategoriEdit"></div>
                    <button type="submit" class="btn btn-success w-100">Simpan Perubahan</button>
                </form>
            </div>
        </div>
